	   ...
	   <form method="post" action="index.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>&view=<?php echo 'HOME'; ?>">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $product_array[$key]["category"]; ?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../../ADMIN/include/activity/<?php echo $product_array[$key]["image"];  ?>" alt="IMG-PRODUCT" style="width:50%; height:200px;">
							<input type="hidden" name="quantity" value="1" max="<?php echo $remaining_stock; ?>" size="2" class="input-cart-quantity" />
							
						
							<a href="index.php?view=<?php ECHO 'SPECIFIC'; ?>&code=<?php echo $product_array[$key]["code"]; ?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								ADD TO CART
								</a>
						</div>
			...
			<form method="post" action="index.php?view=<?php echo 'HOME'; ?>">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $product_array[$key]["category"]; ?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../include/activity/<?php echo $product_array[$key]["image"];  ?>" alt="IMG-PRODUCT" style="width:50%; height:200px;">
