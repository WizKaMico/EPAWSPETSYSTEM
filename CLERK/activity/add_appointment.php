...
if(isset($_POST['submit'])){
    ...
    $query1 = mysqli_query($conn, "INSERT INTO appointment (pcode, fullname, email, phone, state, pet, date_appointment, time, status, date_created) VALUES ('$pcode', '$fullname', '$email', '$phone', '$state', '$pet', '$date_appointment', '$time', '$status', '$date_created')") or die(mysqli_error());
