			...
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="../../ADMIN/include/activity/<?php echo $crow["image"]; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="../../ADMIN/include/activity/<?php echo $crow["image"]; ?>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../../ADMIN/include/activity/<?php echo $crow["image"]; ?>">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					...
					<!-- 		<div class="flex-w flex-r-m p-b-10">
						 ...
						 <form method="post" action="index.php?action=add&code=<?php echo $crow['code']; ?>&view=<?php echo 'SPECIFIC'; ?>&user_id=<?php echo $user_id; ?>">
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<input class="mtext-104 cl3 txt-center num-product" type="number"  name="quantity" min="1" max="<?php echo $remaining_stock; ?>">
