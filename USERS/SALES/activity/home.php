	...
	<section class="bg0 p-t-23 p-b-140">
	   ...
	   <form method="post" action="index.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>&view=<?php echo 'HOME'; ?>&user_id=<?php echo $user_id; ?>">
			...
			<?php }else{ ?>
			<form method="post" action="index.php?view=<?php echo 'HOME'; ?>&user_id=<?php echo $user_id; ?>">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $product_array[$key]["category"]; ?>">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
