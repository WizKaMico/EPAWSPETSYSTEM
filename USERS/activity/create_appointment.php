...
if(isset($_POST['submit'])){
    ...
    $query1 = mysqli_query($conn, "INSERT INTO appointment (pcode, fullname, email, phone, state, pet, date_appointment, time, status, date_created, pet_id) VALUES ('$pcode', '$fullname', '$email', '$phone', '$state', '$pet', '$date_appointment', '$time', '$status', '$date_created', '$pet_id')") or die(mysqli_error());
 ...
 require 'mailler/autoload.php';
      ...
      $subject = 'EPAWS | APPOINTMENT ON '.strtoupper($date_appointment).' | PCODE : '.strtoupper($title).' ';
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="content-block">
                  <span class="apple-link">OCAS ADDRESS : </span>
                   <a href="#"></a>.
                </td>
              </tr>
              <tr>
                <td class="content-block powered-by">
                  Powered by <a href="#"">OCAS PH</a>.
                </td>
              </tr>
            </table>
          </div>
